...
const defaultTestimonials = [
  {
    quote:
      "Mutant Technologies delivered on every promise. Their in-depth understanding of digital marketing has propelled our product to new heights.",
    author: "Issa Yattassaye",
    role: "Product Manager",
  },
  {
    quote:
      "From start to finish, Mutant Technologies provided stellar service and results. Their dedication and skill have made a remarkable difference for us.",
    author: "Kim Loah",
    role: "Manager",
  },
  {
    quote:
      "The team at Mutant Technologies transformed our online strategy with their expertise and creativity. Their commitment to our growth has been exceptional.",
    author: "Nicolas Boucher",
    role: "Head Marketing",
  },
  {
    quote:
      "Working with Mutant Technologies has been a game-changer. Their tailored approach and strategic insights have significantly enhanced our digital presence.",
